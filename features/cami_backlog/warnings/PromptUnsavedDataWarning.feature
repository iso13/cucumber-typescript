@promptUnsavedDataWarning @cami
Feature: Prompt Unsaved Data Warning
  As a User
  I want a warning dialog to appear if I attempt to navigate away from page when there is unsaved data
  So I won't lose the work I've done on group profile,census,classes etc
