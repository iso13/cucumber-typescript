...
Feature: List Groups
  ...
  @critical @wip
  Scenario: List of groups allows user to search groups by their name, requester's name and status
  ...
  Scenario: List of groups allows user to toggle the number of groups displayed per page
