...
Feature: Retrieve Proposals Through Email
  ...
  Scenario: Requester gets a proposal email  new session
    Given I am logged in favorite email client
    And I am the owner of a group
    When an active user creates a proposal for my group
    And I get the email link for the proposal
  ...
  Scenario: Requester do not get an email if he is not the group owner
    Given I am logged in favorite email client
  ...
  Scenario: Requester do not get an email if setting for Retrieve Proposals is not active
    Given I am logged in favorite email client
