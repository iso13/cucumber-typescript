@principal @reviewCriticalIllnessPlanDesign @planDesigner @critical @wip
Feature: Review Critical Illness Plan Design
  As a Requester
  I want to be able to see correct set of benefits and set values for them
  So I can setup my Critical Illness custom plan for further quoting
