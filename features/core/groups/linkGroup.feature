...
Feature: Link group
  ...
  Scenario: When I link a group I should be able to access that linked group from the 'view linked groups' button

  Scenario: The 'view linked groups' button should contain the number of groups that are linked to this group
  ...
  Scenario: Set dual activity for 1 linked group

  Scenario: Remove linked groups from a group profile

  Scenario: Linked groups should be easily identifiable in the groups list via a linked group icon

  Scenario: Dual Activity groups should be easily identifiable in the groups list via a dual activity icon
  ...
  Scenario: A group can not be deleted from the group list if the group is linked or dual activity
